...
@Configuration
@ComponentScan(basePackageClasses = {SchwabAccountsAndTradingApiClient.class, SchwabOauth2Controller.class})
...
public class SchwabAccountsAndTradingApiClientConfig {
    ...
    @Bean
    public WebClient schwabAccountsAndTradingWebClient() {
